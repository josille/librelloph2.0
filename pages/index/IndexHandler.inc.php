...
class IndexHandler extends Handler {
	...
	function index($args, &$request) {
		...
		if ($journal) {
			...
			$templateMgr->assign('journalFlag','true');
			...
			$articles =& $articleDao->getPublishedArticlesByJournalId($journal->getId(),$rangeInfo,true);
			...
			import('lib.pkp.classes.db.DBResultRange');
			$rangeInfo = new DBResultRange(10, 1);
			$articles =& $articleDao->getPublishedArticlesByJournalId(null,$rangeInfo,true);
