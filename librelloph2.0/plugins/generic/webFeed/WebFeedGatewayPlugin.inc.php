...
class WebFeedGatewayPlugin extends GatewayPlugin {
	...
	function fetch($args) {
		...
		/*
		 * latestmain: latest publication main
		 * recent:  latest publication journal
		 * empty: current issue (Dafualt)
		 */
		...
		// by RDLG, option to select type of rss
		...
		//Option recent added by RDLGC
		if ($displayItems == 'recent' && $recentItems > 0 && $option =='recent') {
