...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value">
			<textarea name="authors[{$authorIndex|escape}][affiliation][{$formLocale|escape}]" id="authors-{$authorIndex|escape}-affiliation" rows="5" cols="40" class="textArea" >{$author.affiliation[$formLocale]|escape}</textarea><br/>
