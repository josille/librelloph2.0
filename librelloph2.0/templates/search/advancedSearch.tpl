...
<table class="data search_table" width="100%">
<tr valign="top">
	<td width="25%" class="label"><label for="advancedQuery">{translate key="search.searchAllCategories"}</label></td>
	<td width="75%" class="value"><input placeholder="Search by categories..." type="text" id="advancedQuery" name="query" size="40" maxlength="255" value="{$query|escape}" class="textField" /></td>
</tr>
{if $siteSearch}
<tr valign="top">
...
<tr valign="top">
	...
	<td class="value"><input placeholder="Search by Author name and/or lastname..." type="text" name="author" id="author" size="40" maxlength="255" value="{$author|escape}" class="textField" /></td>
</tr>
<tr valign="top">
	<td class="label"><label for="title">{translate key="article.title"}</label></td>
	<td class="value"><input placeholder="Search by Article title..." type="text" id="title" name="title" size="40" maxlength="255" value="{$title|escape}" class="textField" /></td>
</tr>
<tr valign="top">
	<td class="label"><label for="fullText">{translate key="search.fullText"}</label></td>
	<td class="value"><input placeholder="Search by Article full text..." type="text" id="fullText" name="fullText" size="40" maxlength="255" value="{$fullText|escape}" class="textField" /></td>
</tr>
<tr valign="top">
	<td class="label"><label for="supplementaryFiles">{translate key="article.suppFiles"}</label></td>
	<td class="value"><input placeholder="Search by Article Supplementary Files..." type="text" id="supplementaryFiles" name="supplementaryFiles" size="40" maxlength="255" value="{$supplementaryFiles|escape}" class="textField" /></td>
</tr>
<tr valign="top">
...
<tr valign="top">
	...
	<td class="value"><input placeholder="Search by discipline..." type="text" name="discipline" id="discipline" size="40" maxlength="255" value="{$discipline|escape}" class="textField" /></td>
</tr>
<tr valign="top">
	<td class="label"><label for="subject">{translate key="search.subject"}</label></td>
	<td class="value"><input placeholder="Search by Subject..." type="text" name="subject" id="subject" size="40" maxlength="255" value="{$subject|escape}" class="textField" /></td>
</tr>
<tr valign="top">
...
<p><input class="btn btn-info" type="button" onclick="ensureKeyword();" value="{translate key="common.search"}" class="button defaultButton" /></p>
