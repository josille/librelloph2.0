...
class Issue extends DataObject {
	...
	function getNiceFileSize($issueId){
		...
		$issue_name = $this->getLocalizedOriginalFileName();
		...
		return $JournalFileManager->viewSize('issues/'.$issueId.'/'.$issue_name);
	}
	 ...
	 * @param $custom bool long by RDLG to support a custom issue title
	 * @return string
	 */
	function getIssueIdentification($default = false, $breadcrumb = false, $long = false, $custom = false) {
