		...
		switch ("$page/$op") {
			...
			case 'copyeditor/saveMetadata':
				...
				for ($i=0; $i<$count; $i++) {
					...
					/*
					 * by rdlg, to make affiliations textarea editable
					 */
		...
		if (!empty($enableFields)) {
			...
			<script language="javascript" type="text/javascript">
				tinyMCE.init({
					...
					theme : "advanced",
					theme_advanced_buttons1 : "cut,copy,paste,|,bold,italic,underline,bullist,numlist,|,sub,sup,|,forecolor,|,link,unlink,help,code,fullscreen,jbimages",
